...
Submit these PRs to get passive discovery from high-star lists.

---

## 1. awesome-claude-code (21.6k stars)
...
## 2. open-source-mac-os-apps (43k stars)
**Repo:** https://github.com/serhii-londar/open-source-mac-os-apps
**Section:** Menu Bar Apps or Developer Tools
...
## 3. awesome-mac (76k stars)
**Repo:** https://github.com/jaywcjlove/awesome-mac
**Section:** Developer Tools > Utilities
...
Submit via their web form. Category: Developer Tools / Productivity

---

## How to submit a PR (if unfamiliar)
1. Go to the repo URL
2. Find the correct section in the README
3. Click the pencil (edit) icon
4. Add the line in the right alphabetical position
5. Scroll down, fill in PR title from above
